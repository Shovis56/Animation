...
public class ManyFunctions
{
    ...
    {
        if (num % 2 !=0) //this is doing division of the number given then checking what the reminder is to define if odd
        {
            return true;
        }
        return false;
    ...
    {
        if (num % 2 == 0)// use two = to say it is equal to zero
        {return true;
    }
    return false;
    }
    ...
    {
        return "AEIOUaeiou".indexOf(v) != -1;//indexOF checks passed params and tells if true or false. Need more clarification of -1
    }
